...
int InitLSM9DS1()
{
	...
	SendStart();
	r = SendByte( AG_ADDY );
	if( r ) { SendStop(); SendString(PSTR("AG Fault")); return -3; }
	SendByte( 0x22 );
	...
	SendStart();
	r = SendByte( MA_ADDY );
	if( r ) { SendStop(); SendString(PSTR("MA Fault")); return -14; }
	SendByte( 0x21 );
	...
	SendStart();
	r = SendByte( AG_ADDY );
	if( r ) { SendStop(); SendString(PSTR("AG FaultB")); return -5; }
	SendByte( 0x22 );
	...
	SendStart();
	r = SendByte( AG_ADDY );
	if( r ) { SendStop(); SendString(PSTR("AG FaultA")); return -6; }
	SendByte( 0x2E );
	...
	SendStart();
	r = SendByte( AG_ADDY );
	if( r ) { SendStop(); SendString(PSTR("AG FaultC")); return -7; }
	SendByte( 0x10 );
	...
	SendStart();
	r = SendByte( AG_ADDY );
	if( r ) { SendStop(); SendString(PSTR("AG Fault")); return -8; }
	SendByte( 0x1E );
	...
	SendStart();
	r = SendByte( MA_ADDY );
	if( r ) { SendStop(); SendString(PSTR("MA Fault")); return -9; }
	SendByte( 0x20 );
